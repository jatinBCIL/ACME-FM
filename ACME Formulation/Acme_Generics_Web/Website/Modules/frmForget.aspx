<%@ page language="C#" autoeventwireup="true" inherits="frmForget, App_Web_begpudoz" %>
...
<body style="background-image:none; background-color:White; margin:0;font-family:Arial; font-size:12pt;">
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager> 
        <table style="width: 538px">
            ...
            <tr>s
                <td align="left">
                    <asp:Image ID="Image1" runat="server" ImageUrl="App_Themes/Styles/Images/logo.png"
                        Height="51px" Width="198px" />
                </td>
            </tr>
            <tr>
