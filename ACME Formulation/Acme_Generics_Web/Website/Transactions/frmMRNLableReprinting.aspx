<%@ page title="" language="C#" masterpagefile="~/Modules/MasterPage.master" autoeventwireup="true" inherits="frmMRNLableReprinting, App_Web_plnu4cay" %>
                ...
                <tr>
                    <td style="height: 30px; background-image: url('../App_Themes/Styles/Images/Form_Title.JPG');
                        ...
                        <asp:Label ID="Label35" runat="server" CssClass="HeadingLabel" 
                            Text="MRN Label Reprinting"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lblDocumentNo" runat="server" CssClass="Label" 
                                                            Text="Product Batch No :"></asp:Label>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="Btntest" runat="server" CssClass="Button" Text="Print" ValidationGroup="PrintLabel"
                                                            Width="75px" OnClick="Btntest_Click" Visible="false" />
                                                    </td>
                                                    <td>
                                                        &nbsp;
                                                    </td>
                                        ...
                                        <td style="height: 30px;">
                                            <asp:Panel ID="Panel1" runat="server" Height="400px" ScrollBars="Auto">
                                                <asp:GridView ID="GrGRNDetails" runat="server" AllowPaging="True" AllowSorting="True"
                                                    ...
                                                    Width="100%" OnSelectedIndexChanged="GrGRNDetails_SelectedIndexChanged">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="MRN_PName" HeaderText="Product Name" SortExpression="MRN_PName" />
                                                        <asp:BoundField DataField="InwardNo" HeaderText="InwardNo" SortExpression="InwardNo" />
                                                        <asp:BoundField DataField="MaterialCode" HeaderText="Material Code" SortExpression="MaterialCode" />
                                                        <asp:BoundField DataField="MaterialName" HeaderText="Material Name" SortExpression="MaterialName" />
                                                        <asp:BoundField DataField="NWeight" HeaderText="Net" SortExpression="NWeight" />
                                                        <asp:BoundField DataField="GWeight" HeaderText="Gross" SortExpression="GWeight" />
                                                        <asp:BoundField DataField="TWeight" HeaderText="Tare" SortExpression="GWeight" />
                                                    </Columns>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <asp:TextBox ID="txtReason" runat="server" CssClass="TextBox" Height="25px"
                                                            SkinID="NAME" Width="300px"></asp:TextBox>
                                                    </td>
                                                    <td><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                            ControlToValidate="txtReason" ErrorMessage="RequiredFieldValidator" ToolTip="Reason is required!!!"
