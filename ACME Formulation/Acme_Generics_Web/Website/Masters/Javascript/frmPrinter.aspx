<%@ page language="C#" title="e-Track-Printer Master" autoeventwireup="true" masterpagefile="~/Modules/MasterPage.master" inherits="Masters_frmPrinter, App_Web_bs400pyy" %>
                                                                        ...
                                                                        <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                    ...
                                                                                    <%--    <tr>
                                                                                            ...
                                                                                            <td colspan="2">
                                                                                                <asp:DropDownList ID="ddlDepartmentCode" runat="server" AutoPostBack="True" CssClass="Combobox"
                                                                                                    Width="210px" OnSelectedIndexChanged="ddlDepartmentCode_SelectedIndexChanged">
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddlDepartmentCode"
                                                                                                    ErrorMessage="Select Department code" InitialValue="Select" ToolTip="select Department code is required!!!"
                                                                                ...
                                                                                title="Department code is required!!!" /></asp:RequiredFieldValidator>
                                                                                        ...
                                                                                        <%--<tr>
                                                                                            <td>
                                                                                                <asp:Label ID="Label7" runat="server" CssClass="Label" Text="Department Desc :"></asp:Label>
                                                                                            </td>
                                                                                            <td colspan="2">
                                                                                                <asp:Label ID="lblDesc" Text="  " runat="server" CssClass="Label"></asp:Label>
                                                                                            </td>
                                                                                            <td>
                                                                                            </td>
                                                                                            <td>
                                                                ...
                                                                <td style="width: 50%">
                                                                    <asp:Panel ID="pnlImport" runat="server" ScrollBars="Auto" Height="400px">
                                                                        <asp:GridView ID="GrPrinter_Grid" runat="server" AllowPaging="True" AllowSorting="True"
                                                                            ...
                                                                            Height="16px" Width="800px" OnPageIndexChanging="GrPrinter_Grid_PageIndexChanging1"
                                                                            OnRowDataBound="GrPrinter_Grid_RowDataBound1">
                                                                            <Columns>
                                                                                <asp:BoundField DataField="PLANT CODE" HeaderText="PLANT CODE" SortExpression="PlantID" />
                                                                                <asp:BoundField DataField="DEPARTMENT DESCRIPTION" HeaderText="DEPARTMENT DESCRIPTION" SortExpression="DEPARTMENT DESCRIPTION" />
                                                                                <asp:BoundField DataField="PRINTER CODE" HeaderText="PRINTER CODE" SortExpression="PRINTER CODE" />
                                                                                <asp:BoundField DataField="PRINTER IP" HeaderText="PRINTER IP" SortExpression="PRINTER IP" />
                                                                                 <asp:BoundField DataField="PRINTER PORT" HeaderText="PRINTER PORT" SortExpression="PRINTER PORT" />
                                                                                  <asp:BoundField DataField="AREA CUBICLE CODE" HeaderText="AREA CUBICLE CODE" SortExpression="AREA CUBICLE CODE" />
