<%@ page title="" language="C#" masterpagefile="~/Modules/MasterPage.master" autoeventwireup="true" inherits="frmUser_Master, App_Web_jpxrpax2" %>
                                                                ...
                                                                <td style="width: 40%;">
                                                                    <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" EnableTheming="True"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:DropDownList ID="ddType" runat="server" AutoPostBack="True" CssClass="Combobox"
                                                                                                Height="25px" Width="224px">
                                                                                                <asp:ListItem>Select</asp:ListItem>                                                      <asp:ListItem>Select</asp:ListItem>
                                                                                        ...
                                                                                        <td style="width: 50%;" valign="top">
                                                                                            <asp:Panel ID="pnlImport" runat="server" ScrollBars="Auto" Height="400px">
                                                                                                ...
                                                                                                <asp:Button ID="btnCancel" runat="server" CssClass="Button" Text="Cancel" Width="60px"
                                                                                                    OnClick="btnCancel_Click" /></asp:Panel>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </ContentTemplate>
                                                                        ...
                                                                        <asp:TabPanel ID="TabPanel4" runat="server" HeaderText="TabPanel3">
                                                                            <HeaderTemplate>
                                                                                Rights</HeaderTemplate>
                                                                            <ContentTemplate>
                                                                                <div style="width: 100%; font-family: Calibri; font-size: 12px">
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Label ID="Label8" runat="server" CssClass="Label" Text="User ID:"></asp:Label><asp:DropDownList
                                                                                                    ID="ddlUserid" runat="server" CssClass="Combobox" AutoPostBack="true" OnSelectedIndexChanged="ddlUserid_SelectedIndexChanged1">
                                                                                                </asp:DropDownList>
                                                                                                <asp:Image ID="Image18" runat="server" Height="10px" Width="10px" ToolTip="Mandatory Field!!!"
                                                                                                    ImageUrl="../App_Themes/Styles/Images/img_mand.png" /><asp:RequiredFieldValidator
                                                                                                        ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddlUserid" InitialValue="Select"
                                                                                                        ErrorMessage="User ID is required!!!" Text="&lt;img src='../App_Themes/Styles/Images/err1.png' title='User ID required!!!' /&gt;"
                                                                                                        ToolTip="User ID required!!!" ValidationGroup="SaveRights"></asp:RequiredFieldValidator>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr id="trDetails" style="visibility:collapse">
                                                                                            <td>
                                                                                                <table>
                                                                                                    <tr>
                                                                                                ...
                                                                                                <div style="border: 2px solid black">
                                                                                                    <table>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                                                                    <ContentTemplate>
                                                                                                                        <asp:TextBox ID="txtTplant" ReadOnly="true" runat="server" ValidationGroup="Save"></asp:TextBox><asp:Button
                                                                                                                            ID="btnTPlant" runat="server" Text="Select" CssClass="Button" Width="80px" /><cc1:ModalPopupExtender
                                                                                                                                ID="mp1" runat="server" PopupControlID="pnlPlant1" TargetControlID="btnTPlant"
                                                                                                                        ...
                                                                                                                        <asp:Panel ID="pnlPlant1" runat="server" CssClass="modalPopup" ScrollBars="Auto"
                                                                                                                            ...
                                                                                                                            <table class="Popup_Table">
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td class="style4">
                                                                                                                                        <asp:Button ID="btnTPlantOk" runat="server" CssClass="Button" Text="OK" UseSubmitBehavior="False"   OnClick="btnTPlantOk_Click"/>
                                                                                                                                    </td>
                                                                                                                                    <td>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                                                                    <ContentTemplate>
                                                                                                                        <asp:TextBox ID="txtTRole" ReadOnly="true" runat="server" ValidationGroup="Save"></asp:TextBox><asp:Button
                                                                                                                            ID="btnTrole" runat="server" Text="Select" CssClass="Button" Width="80px" /><cc1:ModalPopupExtender
                                                                                                                                ID="ModalPopupExtender2" runat="server" PopupControlID="Panel3" TargetControlID="btnTrole"
                                                                                                                                CancelControlID="btnTRoleClose" BackgroundCssClass="modalBackground">
                                                                                                                            </cc1:ModalPopupExtender>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:TextBox ID="txtTDate" runat="server" CssClass="DateTimeText"></asp:TextBox><asp:CalendarExtender
                                                                                                                    ID="CalendarExtender4" runat="server" Enabled="True" TargetControlID="txtTDate"
                                                                                                                    Format="dd/MM/yyyy">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Button ID="btnSaveRight" runat="server" CssClass="Button" Text="Save" UseSubmitBehavior="False"
                                                                                                    Visible="true" OnClick="btnSaveRight_Click1" /><asp:Button ID="btnCancelRight" runat="server"
                                                                                                        CssClass="Button" Text="Cancel" UseSubmitBehavior="False" Visible="true" />
                                                                                            </td>
                                                                                        </tr>
                                                                                        <td colspan="4" style="height: 10px; background-image: url('../App_Themes/Styles/Images/Form_Title.JPG');
                                                                                            background-repeat: repeat-x">
                                                                                                ...
                                                                                                <td style="width: 50%;" valign="top">
                                                                                                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Height="400px">
                                                                                                        <asp:GridView ID="grdExcelRight" runat="server" AllowPaging="True" AllowSorting="True"
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                <asp:BoundField DataField="USER ID" HeaderText="USER ID" SortExpression="USER ID" />
                                                                                                                <asp:BoundField DataField="PLANT ID TRAN" HeaderText="PLANT ID TRAN" SortExpression="PLANT ID TRAN" />
                                                                                                                <asp:BoundField DataField="DEPARTMENT TRAN" HeaderText="DEPARTMENT TRAN" SortExpression="DEPARTMENT TRAN" />
                                                                                                                <asp:BoundField DataField="ACCESS  UPTO TRAN" HeaderText="ACCESS  UPTO TRAN" SortExpression="ACCESS  UPTO TRAN" />
                                                                                                                <asp:BoundField DataField="PLANT ID DISPLAY" HeaderText="PLANT ID DISPLAY" SortExpression="PLANT ID DISPLAY" />
                                                                                                                <asp:BoundField DataField="DEPARTMENT DISPLAY" HeaderText="DEPARTMENT DISPLAY" SortExpression="DEPARTMENT DISPLAY" />
                                                                                                                <asp:BoundField DataField="ACCESS UPTO DISPLAY" HeaderText="ACCESS UPTO DISPLAY"
                                                                                                                    SortExpression="ACCESS UPTO DISPLAY">
                                                                                                                    <HeaderStyle Width="120px" />
                                                                                                                </asp:BoundField>
                                                                                                            </Columns>
                                                                                                            <PagerSettings Position="TopAndBottom" />
                                                                                                        ...
                                                                                                        <asp:Button ID="btnCancelRightExcel" runat="server" CssClass="Button" Text="Cancel"
                                                                                                            Width="60px" OnClick="btnCancelRightExcel_Click" /></asp:Panel>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </table>
