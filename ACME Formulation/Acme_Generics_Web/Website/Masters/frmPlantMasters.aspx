<%@ page title="e-Track-Plant Master" language="C#" masterpagefile="~/Modules/MasterPage.master" autoeventwireup="true" inherits="Masters_frmPlantMasters, App_Web_jpxrpax2" %>
                                                                        ...
                                                                        <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                <table style="width: 100%">
                                                                                    <tr>
                                                                                        <td colspan="2" style="height: 10px; background-image: url('../App_Themes/Styles/Images/Form_Title.JPG');
                                                                                            background-repeat: repeat-x">
                                                                                                    ...
                                                                                                    &nbsp;&nbsp;
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:Button ID="btnImp" runat="server" CssClass="Button" ValidationGroup="Upload"
                                                                                                                    OnClick="btnImp_Click"  Text="Import" Width="60px" />
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </table>
                                                                                                </ContentTemplate>
                                                                                ...
                                                                                src="../App_Themes/Styles/Images/err1.png" title="Address is required!!!" /></asp:RequiredFieldValidator>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:Label ID="lblstate" runat="server" CssClass="Label" Text="Address Line 5 :"></asp:Label>
                                                                                        </td>
                                                                                        <td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:Label ID="lblcity" runat="server" CssClass="Label" Text="Address Line 6 :"></asp:Label>
                                                                                        </td>
                                                                                        <td>
                                                                ...
                                                                <td style="width: 50%;" valign="top">
                                                                    <asp:Panel ID="pnlImport" runat="server" ScrollBars="Auto" Height="400px">
                                                                        <asp:GridView ID="grPlant1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                            ...
                                                                            Width="825px" OnPageIndexChanging="grPlant1_PageIndexChanging" OnRowDataBound="grPlant1_RowDataBound">
                                                                            <Columns>
                                                                                <asp:BoundField DataField="LOCATION" HeaderText="LOCATION" SortExpression="PLANT ID" />
                                                                                <asp:BoundField DataField="PLANT CODE" HeaderText="PLANT CODE" SortExpression="PLANT LOCATION" />
                                                                                <asp:BoundField DataField="PLANT DESCRIPTION" HeaderText="PLANT DESC" SortExpression="ADDRESS" />
                                                                           <%--     <asp:BoundField DataField="ASSOCIATE PLANT CODE" HeaderText="ASC PLANT CODE" SortExpression="ASSOCIATE_PLANT_CODE" />
                                                                                <asp:BoundField DataField="ASSOCIATE PLANT DESCRIPTION" HeaderText="ASC PLANT DESC" SortExpression="ASSOCIATE_PLANT_DESC" />--%>
                                                                                ...
                                                                                <asp:BoundField DataField="ADDRESS5" HeaderText="ADDRESS5" SortExpression="REMARK" />
                                                                                <asp:BoundField DataField="ADDRESS6" HeaderText="ADDRESS6" SortExpression="REMARK" />
                                                                              
                                                                                 <%-- <asp:BoundField DataField="HOLD DAYS" HeaderText="HOLD DAYS" SortExpression="REMARK" />--%>
                                                                                    <asp:BoundField DataField="PLANT TYPE" HeaderText="PLANT TYPE" SortExpression="REMARK" />
                                        ...
                                        <td style="height: 30px;">
                                            <asp:GridView ID="GrPlant" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                <%--    <asp:BoundField DataField="ASSOCIATEPLANTCODE" HeaderText="ASC PLANT CODE" SortExpression="ASSOCIATE_PLANT_CODE" />
                                                    ...
                                                    <asp:BoundField DataField="ADDRESS5" HeaderText="ADDRESS5" SortExpression="STATE" />
                                                    <asp:BoundField DataField="ADDRESS6" HeaderText="ADDRESS6" SortExpression="CITY" />
