...
public partial class frmGrn_Printing : System.Web.UI.Page
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
                    ...
                    if (cb.Checked == true)
                    {
                        ...
                        else
                        {
                            if (pnlNoofCon.Visible == false)
                            {
                                ...
                                //clsStandards.WriteLog(this, new Exception("Test 1"), clsStandards.GetCurrentPageName(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), 0, true);
                            }
                            ...
                            else
                            {
                                ...
                                if (success)
                                {
                                   ...
                                   // clsStandards.WriteLog(this, new Exception("Test 2"), clsStandards.GetCurrentPageName(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), 0, true);
                                }
                                ...
                                else
                                {
                                    ...
                                    txtNoof.Focus();
                                    return;
                                    ///////clsStandards.WriteLog(this, new Exception("Test 3"), clsStandards.GetCurrentPageName(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), 0, true);
                                }
                            }
                        }
                        //clsStandards.WriteLog(this, new Exception("Test 4"), clsStandards.GetCurrentPageName(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), 0, true);
                        ...
                        if (dtPRint.Rows[0]["Printst"].ToString() == "0")
                        {
                            ...
                            ///clsStandards.WriteLog(this, new Exception("erp 1"), clsStandards.GetCurrentPageName(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), 0, true);
                        }
                        ...
                        //clsStandards.WriteLog(this, new Exception("erp 2"), clsStandards.GetCurrentPageName(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), 0, true);
                        if (pFlag == true)
                        {
        ...
        {
            PrintDirect.CreateLog(ex.ToString());
