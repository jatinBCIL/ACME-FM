    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (dtPrint.Rows.Count > 0)
            {
                ...
                ScriptManager.RegisterStartupScript(btnPrint, this.GetType(), "OpenWindow", "window.open('" + Request.Url.GetLeftPart(UriPartial.Authority) + VirtualPathUtility.ToAbsolute(System.Web.Configuration.WebConfigurationManager.AppSettings["Report"].ToString()) + "rptLocationSheet" + ".aspx" + "','_newtab');", true);
            }
            else
            {
