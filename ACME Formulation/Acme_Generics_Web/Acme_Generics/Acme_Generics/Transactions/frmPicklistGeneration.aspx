<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/MasterPage.master" AutoEventWireup="true"
    CodeFile="frmPicklistGeneration.aspx.cs" Inherits="frmGrn_Printing" %>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td height="30" style="height: 30px; background-image: url('../App_Themes/Styles/Images/Form_Title.JPG');
                                            background-repeat: repeat-x">
                                            <asp:Label ID="Label35" runat="server" CssClass="HeadingLabel" Text="&amp;nbsp;Picklist Generation"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                    <td> &nbsp;
                                            ...
                                            <table >
                                                <tr>
                                                    <td runat="server" visible=false>
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtFrom" runat="server" CssClass="DateTimeText" Width="150px" AutoComplete="off"></asp:TextBox>
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtTo" runat="server" CssClass="DateTimeText" Width="150px" AutoComplete="off"></asp:TextBox>
                                                        <asp:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="True" TargetControlID="txtTo"
                                                            Format="MM/dd/yyyy">
                                                        </asp:CalendarExtender>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:TextBox ID="txtBatchNo" runat="server" CssClass="TextBox" Height="25px" SkinID="NAME"
                                                            Width="289px" autocomplete="off" ></asp:TextBox>
                                                        ...
                                                        <asp:Button ID="btnGet" runat="server" CssClass="Button" Text="Get" Width="75px"
                                                            OnClick="btnGet_Click" />
                                                             <asp:Button ID="Button2" runat="server" CssClass="Button" Style="margin-left: 600px" Text="Refresh" Width="95px"
                                                            OnClick="btnRefresh_Click" />

                                                           <%--  
                                                             <asp:Button ID="Button1" runat="server" CssClass="Button" Style="margin-left: 800px" Text="Refresh" Width="60px"
                                                            ValidationGroup="Get" OnClick="btnRefresh_Click" --%>
                                            ...
                                            <asp:Panel ID="Panel1" runat="server" Height="400px" ScrollBars="Auto">
                                                <asp:GridView ID="GrGRNDetails" runat="server"  AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="LineNo" HeaderText="Line Item No" SortExpression="LineItemNo" />
                                                    </Columns>
