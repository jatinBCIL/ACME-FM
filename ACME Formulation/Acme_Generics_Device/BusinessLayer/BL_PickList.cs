...
namespace BusinessLayer
{
    public class BL_PickList
    {
        ...
        public string BL_ValidatePicking(string strPickListNo, string strMaterial, string strProcOrder, string strBatchNo, string strBarcodeNo, string strType,double Rqty, string strUser, string strPlant)
        {

            DL_PickList objDL = new DL_PickList();
            try
            {
                return objDL.DL_ValidatePicking(strPickListNo, strMaterial,strProcOrder, strBatchNo, strBarcodeNo, strType,Rqty, strUser, strPlant);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.ToString());
