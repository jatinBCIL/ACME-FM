...
public Int16 CheckConnection(string strIP, string strPort)
{
...
public string ReceiveDataFromServer_P()
{
    ...
    try
    {
        if (IsConnected == true)
        {
            ...
            for (i = 0; i <= 10; i++)
            {
                ...
                if (Convert.ToString(System.Text.Encoding.ASCII.GetString(dataBuffer, 0, NoOfBytes)).Contains("\n"))
                {
                    break;
                }
                if (Convert.ToString(System.Text.Encoding.ASCII.GetString(dataBuffer, 0, NoOfBytes)).Contains("\r\n"))
        ...
        if (IsConnected == true)
        {
            ...
            for (i = 0; i <= 20; i++)
            {
                if (!GtcpSocket.Connected)
                {
                    ...
                    NoOfBytes = GtcpSocket.Receive(dataBuffer);
                    strVal = strVal + Convert.ToString(System.Text.Encoding.ASCII.GetString(dataBuffer, 0, NoOfBytes));
                    //strVal =  Convert.ToString(System.Text.Encoding.ASCII.GetString(dataBuffer, 0, NoOfBytes));
                    strVal = strVal.Split('\n')[2];
                }
