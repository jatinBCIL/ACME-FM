...
public partial class frmPicking : System.Web.UI.Page
{
    ...
    protected void btnScanBarcode_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            strResult = objBL.BL_ValidatePicking(txtPicklistNo.Text.Trim(), ddlMaterialCode.Text.Trim(), ddlMaterialCode.Text.Trim(), ddlMatBatch.Text.Trim(), txtMaterialBarCode.Text.Trim(), "VALIDATE", double.Parse(lblRequiredQty.Text), clsStandards.current_Username().ToString(), clsStandards.current_Plant().ToString());
