    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (dtGrn.Rows.Count > 0)
            {
                ...
                lblExpDate.Text = dtGrn.Rows[0]["EXPDate"].ToString() != "1753-01-01" ? dtGrn.Rows[0]["EXPDate"].ToString() : "NA";
                lblMfgDate.Text = dtGrn.Rows[0]["MFGDate"].ToString() != "1753-01-01" ? dtGrn.Rows[0]["MFGDate"].ToString() : "NA";
