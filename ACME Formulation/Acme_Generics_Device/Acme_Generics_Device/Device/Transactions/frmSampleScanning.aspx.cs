...
public partial class frm_FOR_Allocation : System.Web.UI.Page
{
    ...
    protected void btnBalance_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (strResult.StartsWith("0"))
            {
                ...
                strResult = getWeight1(ViewState["IPADDRESS"].ToString(), ViewState["PORT"].ToString());
    ...
    //        // CreateLog("tRY TO CONNECT" + WeighID + " " + Port);
    ...
    //        }
    //        wt = wt.Split('\n')[1];
    //        wt = Regex.Replace(wt.ToString(), "[^0-9. ]", "").Trim();
    //        client.Close();
    //        client = null;
    ...
    //    catch (Exception ex)
    //    {
    //        //CreateLog("Not Connected" + WeighID + " " + Port);
