    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <table width="100%" cellspacing="1px">
                <tr class="alert alert-primary" style="">
                    <td style="background-image: url('../App_Themes/Styles/Images/Form_Title.JPG'); background-repeat: repeat-x;
                        height: 45px" colspan="2" class="style1" bgcolor="#7F65A8">
        ...
        <div class="row">
            <div class="panel-group">
                ...
                <asp:HyperLink ID="A404" runat="server" class="list-group-item" Style="background-color: #2466a8;
                    color: white; top: 0px; left: 0px;" Visible="False" NavigateUrl="~/Device/Transactions/frmDispensing.aspx">Dispensing</asp:HyperLink>
                ...
                <asp:HyperLink ID="A406" runat="server" class="list-group-item" Style="background-color: #2466a8;
                    color: white" Visible="False" NavigateUrl="~/Device/Production/frmMaterialReturn.aspx">MRN Verify</asp:HyperLink>
                <asp:HyperLink ID="A407" runat="server" class="list-group-item" Style="background-color: #2466a8;
                    color: white" Visible="False" NavigateUrl="~/Device/Transactions/frmStatusDisplay.aspx">Display Status</asp:HyperLink>
                <asp:Button ID="btnLogout" Style="background-color: #990033; width: 100%; text-align: left;
                    color: white" class="list-group-item" runat="server" Text="Log Out" OnClick="btnLogout_Click" />
