...
namespace DataLayer
{
    public class DL_PickList
    {
        ...
        public string DL_ValidatePicking(string strPickListNo, string strMaterial,string strProcOrder, string strBatchNo, string strBarcodeNo, string strType,Double Rqty, string strUser, string strPlant)
        {
            SqlDataLayer objSql = new SqlDataLayer();
            ...
            {
                objparam[0] = new SqlParameter("@PICKLISTNO", SqlDbType.VarChar);
                objparam[1] = new SqlParameter("@PROCESSORDERNO", SqlDbType.VarChar);
                objparam[2] = new SqlParameter("@MATERIALCODE", SqlDbType.VarChar);
                objparam[3] = new SqlParameter("@MATERIALBATCH", SqlDbType.VarChar);
                objparam[4] = new SqlParameter("@BARCODENO", SqlDbType.VarChar);
                objparam[5] = new SqlParameter("@TYPE", SqlDbType.VarChar);
                objparam[6] = new SqlParameter("@RQTY", SqlDbType.Decimal);
                ...
                objparam[0].Value = strPickListNo;
                objparam[1].Value = strProcOrder;
                objparam[2].Value = strMaterial;
                objparam[3].Value = strBatchNo;
                objparam[4].Value = strBarcodeNo;
                objparam[5].Value = strType;
                objparam[6].Value = Rqty;
                objparam[7].Value = strPlant;
